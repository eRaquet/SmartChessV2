...
from smartchess.model import RandomModel
...
if __name__ == '__main__':
    ...
    white_agent = ModelAgent(RandomModel(), confidence_factor=1.0)
    black_agent = ModelAgent(RandomModel(), confidence_factor=1.0)
